...
const Banner = () => {
    return (
        ...
        <div id="slide1" className="carousel-item relative w-full">
          <img src={img1}className="rounded-xl w-full h-[600px]" />
          <div className="absolute bottom-0 flex items-center left-0 top-0
          bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0) 100%)] h-full rounded-xl">
